...
<template>
  <Link :href="href" type="button" :as="tag" :class="[classBtn, 'inline-flex text-sm py-1.5 px-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150 disabled:opacity-50']">
